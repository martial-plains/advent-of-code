...
#[cfg(test)]
mod tests {
    use crate::year_2015::day_05::Day05;

    const INPUT: &str = include_str!("input.txt");

    #[test]
    fn test_part1_examples() {
        assert_eq!(Day05::part1("ugknbfddgicrmopn"), 1);
        assert_eq!(Day05::part1("aaa"), 1);
        assert_eq!(Day05::part1("jchzalrnumimnmhp"), 0);
        assert_eq!(Day05::part1("haegwjzuvuyypxyu"), 0);
        assert_eq!(Day05::part1("dvszwmarrgswjxmb"), 0);
    }

    #[test]
    fn test_part1_puzzle() {
        assert_eq!(Day05::part1(INPUT), 258);
    }

    #[test]
    fn test_part2_examples() {
        assert_eq!(Day05::part2("qjhvhtzxzqqjkmpb"), 1);
        assert_eq!(Day05::part2("xxyxx"), 1);
        assert_eq!(Day05::part2("uurcxstgmygtbstg"), 0);
        assert_eq!(Day05::part2("ieodomkazucvgmuy"), 0);
    }

    #[test]
    fn test_part2_puzzle() {
        assert_eq!(Day05::part2(INPUT), 53);
    }
}
